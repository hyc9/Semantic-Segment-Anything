...
def semantic_infer_one_image(img: Image.Image, key, processors, models, rank):
    ...
    for ann in anns['annotations']:
        ...
        mask_class[valid_mask.numpy()] = class_name
        processors['local_classnames'].add(class_name)
    
    processors['global_classnames'] = sync_classnames_across_processes(processors['local_classnames'])
    ...
    for mask, name in mask_class.items():
