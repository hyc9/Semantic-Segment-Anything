...
output_dir = '/ssdwork/chengyu/mask_dataset_node8'
...
def main(rank, args):
    ...
    tar_files = tar_files[::-1][:80]
    local_files = tar_files[rank::args.world_size]
    
    processed_tars,processed_imgs = [], []
    resume_path = os.path.join(output_dir, '..', 'mask_precess_resume_node8', f"rank{rank}_resume.json")
    os.makedirs(os.path.join(output_dir, '..', 'mask_precess_resume_node8'), exist_ok=True)
